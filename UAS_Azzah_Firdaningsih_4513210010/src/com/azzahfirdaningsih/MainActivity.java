...
import com.azzahfirdaningsih.MainActivity;
import com.azzahfirdaningsih.Pakaian;
		 ...
		 public void getDataByID(int id) {
		  ...
		  builderEditPakaian.setPositiveButton("Update", new DialogInterface.OnClickListener() {
		   ...
		   public void onClick(DialogInterface dialog, int which) {
		    ...
		    Toast.makeText(MainActivity.this, laporan, Toast.LENGTH_LONG).show();
